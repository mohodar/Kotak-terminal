<template>
  ...
  <section class="row py-3">
    ...
    <div class="row m-0 mt-3">
      <div class="col-12 rounded border p-3 bg-color-2">
        <h6 class="mb-0">Instrument Settings</h6>
        <div class="table-responsive mt-3" style="height: auto;">
          <table class="table table-sm table-borderless text-light">
            ...
            <tbody>
              <tr v-for="(settings, instrument) in quantities" :key="instrument">
                <td class="align-middle">{{ instrument }}</td>
                <td>
                  <input type="number" class="form-control form-control-sm" v-model="settings.lotSize" min="1" />
                </td>
                <td>
                  <input type="number" class="form-control form-control-sm" v-model="settings.maxLots" min="1" />
                </td>
                <td>
                  <input type="number" class="form-control form-control-sm" v-model="settings.freezeLimit" min="1" />
                </td>
              </tr>
            </tbody>
          </table>
